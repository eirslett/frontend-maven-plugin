...
public interface TypescriptRunner {
    ...
    void execute(File argsTxt, File srcdir, boolean preserveDirectoryStructure, File outputdir, boolean removeComments,
            Module module, Target target, String charset, boolean sourceMap, boolean declaration, File mapRoot,
            boolean noImplicitAny, boolean noResolve, boolean noEmitOnError) throws TaskRunnerException;
}
...
final class DefaultTypescriptRunner extends NodeTaskExecutor implements TypescriptRunner {
    ...
    @Override
    public void execute(File argsTxt, File srcDir, boolean preserveDirectoryStructure, File outDir,
            boolean removeComments, Module module, Target target, String charset, boolean sourceMap,
            boolean declaration, File mapRoot, boolean noImplicitAny, boolean noResolve, boolean noEmitOnError)
    ...
    private void compileEntireSrcDir(final File argsTxt, LinkedList<String> args, final File srcDir,
        ...
        if (argsTxt != null) {
            ...
            try {
                ...
                throw new TaskRunnerException("Could not build typescript arguments file '" + argsTxt + "'", e);
            } finally {
